		...
		<div class="row">
				...
				<div class="ui-block">
					...
					<div class="friend-item">
						<div class="friend-header-thumb">
							<img src="static/img/friend1.jpg" alt="friend">
						</div>
						...
						<div class="friend-item-content">
							...
							<div class="friend-avatar">
								<div class="author-thumb">
									<img src="static/img/avatar1.jpg" alt="author">
								</div>
			...
			<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="ui-block">
					...
					<div class="friend-item">
						<div class="friend-header-thumb">
							<img src="static/img/friend2.jpg" alt="friend">
						</div>
						...
						<div class="friend-item-content">
							...
							<div class="friend-avatar">
								<div class="author-thumb">
									<img src="static/img/avatar2.jpg" alt="author">
								</div>
								<div class="author-content">
			...
			<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="ui-block">
					...
					<div class="friend-item">
						<div class="friend-header-thumb">
							<img src="static/img/friend3.jpg" alt="friend">
						</div>
						...
						<div class="friend-item-content">
							...
							<div class="friend-avatar">
								<div class="author-thumb">
									<img src="static/img/avatar3.jpg" alt="author">
								</div>
								<div class="author-content">
									<a href="#" class="h5 author-name">Nicholas Grissom</a>
			...
			<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="ui-block">
					...
					<div class="friend-item">
						<div class="friend-header-thumb">
							<img src="static/img/friend4.jpg" alt="friend">
						</div>
						...
						<div class="friend-item-content">
							...
							<div class="friend-avatar">
								<div class="author-thumb">
									<img src="static/img/avatar4.jpg" alt="author">
								</div>
								<div class="author-content">
			...
			<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="ui-block">
					...
					<div class="friend-item">
						<div class="friend-header-thumb">
							<img src="static/img/friend5.jpg" alt="friend">
						</div>
						...
						<div class="friend-item-content">
							...
							<div class="friend-avatar">
								<div class="author-thumb">
									<img src="static/img/avatar5.jpg" alt="author">
								</div>
								<div class="author-content">
			...
			<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="ui-block">
					...
					<div class="friend-item">
						<div class="friend-header-thumb">
							<img src="static/img/friend6.jpg" alt="friend">
						</div>
						...
						<div class="friend-item-content">
							...
							<div class="friend-avatar">
								<div class="author-thumb">
									<img src="static/img/avatar6.jpg" alt="author">
								</div>
								<div class="author-content">
			...
			<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="ui-block">
					...
					<div class="friend-item">
						<div class="friend-header-thumb">
							<img src="static/img/friend7.jpg" alt="friend">
						</div>
						...
						<div class="friend-item-content">
							...
							<div class="friend-avatar">
								<div class="author-thumb">
									<img src="static/img/avatar7.jpg" alt="author">
								</div>
								<div class="author-content">
			...
			<div class="col col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="ui-block">
					...
					<div class="friend-item">
						<div class="friend-header-thumb">
							<img src="static/img/friend8.jpg" alt="friend">
						</div>
						...
						<div class="friend-item-content">
							...
							<div class="friend-avatar">
								<div class="author-thumb">
									<img src="static/img/avatar8.jpg" alt="author">
								</div>
								<div class="author-content">
