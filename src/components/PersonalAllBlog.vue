				...
				<div class="ui-block">
					...
					<article class="hentry post has-post-thumbnail">
						...
						<div class="post-thumb">
							<img src="img/post__thumb2.jpg" alt="photo">
						</div>
			...
			<div class="col col-xl-6 col-lg-12 col-md- col-sm-12 col-12">
				...
				<div class="ui-block">
					...
					<article class="hentry post video">
						...
						<div class="post-video">
							<div class="video-thumb f-none">
								<img src="img/video6.jpg" alt="photo">
								<a href="https://youtube.com/watch?v=excVFQ2TWig" class="play-video">
									<svg class="olymp-play-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-play-icon"></use></svg>
								</a>
							</div>
				...
				<div class="ui-block">
					...
					<article class="hentry post">
						...
						<div class="post-block-photo js-zoom-gallery">
							<a href="img/post-photo1.jpg" class="half-width"><img src="img/post-photo1.jpg" alt="photo"></a>
